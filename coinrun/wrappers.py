...
class EpisodeRewardWrapper(gym.Wrapper):
    def __init__(self, env):
        ...
        def step(action):
            ...
            # print("whether use aux reward or not: {}".format(use_aux)) #sure the answer is False
            ...
            for i, d in enumerate(done):
                if d:
                    ...
                    # print("{} th env is done, the epinfo['r'] and epinfo['l'] are:  {} {}".format(i, epinfo['r'], epinfo['l']))
                    #one example of epinfo['r'] and epinfo['l'] is : 180, 681.
                    aux_dict = {}
